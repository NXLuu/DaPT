class CreateDataset:
    ...
    # Train Path
    data_paths = [
        "D:\Kì 4\Đa phương tiện\Dataset\Đơn tấu\wav",
        'D:\Kì 4\Đa phương tiện\Dataset\Song tấu\wav',
        'D:\Kì 4\Đa phương tiện\Dataset\Hòa tấu\wav'
    ];
    # Sampling rate
    sr = 22050
    # Frame size (samples)
    ...
    ts = 6
    # Name of Instrument
    labels =  ['đơn tấu','song tấu','hòa tấu'];
    # Label map
    label_map = {
        'đơn tấu' : 1,
        'song tấu' : 2,
